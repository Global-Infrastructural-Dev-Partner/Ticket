<%-- 
    ...
    Created on : 25-Nov-2019, 21:43:01
    Author     : ndfmac
--%>
                                            ...
                                            <div class="col-lg-4 col-xs-6">
                                                ...
                                                <div class="small-box bg-yellow">
                                                    <div class="inner">
                                                        ...
                                                        <p>Total No of Tickets Paid For</p>
                                                    </div>
                                                    <div class="icon">
                                            ...
                                            <div class="col-lg-4 col-xs-6">
                                                ...
                                                <div class="small-box bg-red">
                                                    <div class="inner">
                                                        ...
                                                        <p>Total No of Tickets Given For Free</p>
                                                    </div>
                                                    <div class="icon">
                                            ...
                                            <div class="col-lg-4 col-xs-6">
                                                ...
                                                <div class="small-box bg-aqua">
                                                    <div class="inner">
                                                        ...
                                                        <p>Total No of Tickets 5 in 1 Sold</p>
                                                    </div>
                                                    <div class="icon">
                                                        <i class="ion ion-bag"></i>
                                                    </div>
                                            ...
                                            <div class="col-lg-4 col-xs-6">
                                                ...
                                                <div class="small-box bg-green">
                                                    <div class="inner">
                                                        ...
                                                        <p>Total No of Tickets 10 in 1 Sold</p>
                                                    </div>
                                                    <div class="icon">
                                                        <i class="ion ion-stats-bars"></i>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-xs-6">
                                                ...
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        <span class="info-box-text">Amount in All Wallet</span>
                                            ...
                                            <div class="col-lg-4 col-xs-6">
                                                ...
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        <span class="info-box-text">Amount in Admin Wallet</span>
                                                        <span class="info-box-number">&#8358; 122,000</span>
                                                    </div>
                                                    <!-- /.info-box-content -->
                                                </div>
                                            </div>
